  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <button className="btn btn-secondary" onClick={() => navigate('/references')} style={{ justifyContent: 'flex-start' }}>
          <Database size={18} /> Справочники
        </button>
        <ExportExcel />
      ...
      <div style={{ marginTop: 24, padding: 12, background: 'var(--surface)', borderRadius: 12, textAlign: 'center' }}>
        <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>Бистро24 v1.0</div>
